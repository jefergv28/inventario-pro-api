        ...
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers(
                    ...
                    "/v3/api-docs/**",
                    // --- INICIO DE CAMBIOS ---
                    "/uploads/**",     // Permite acceso a todas las imágenes en /uploads/
                    "/profile-image.jpg"     // Permite acceso a la imagen default.png
                    // --- FIN DE CAMBIOS ---
                ).permitAll()
                .requestMatchers("/proveedores/**").authenticated()
                .requestMatchers("/categorias").permitAll() // Si /categorias no requiere autenticación
